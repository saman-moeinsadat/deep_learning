...
def execute(link):
    ...
    print(
        ...
        label_provider(model_cnn, link, cnn_mean, cnn_std)
        )
    ...
    print(
        ...
        label_provider(model_ft, link, resnet18_mean, resnet18_std)
    )
    # shutil.rmtree('/home/saman/python-projects/test/sub')
    # os.mkdir('/home/saman/python-projects/test/sub')
execute('https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/ADAC-Logo.svg/150px-ADAC-Logo.svg.png')

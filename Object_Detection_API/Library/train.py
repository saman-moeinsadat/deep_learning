...
import Object_Detection_API.Library.test  # import test.py to get mAP after each epoch
from Object_Detection_API.Library.models import *
...
wdir = 'weights_1' + os.sep  # weights dir
last = wdir + 'last.pt'
best = wdir + 'best.pt'
...
def train():
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if save:
            ...
            # Save backup every 40 epochs (optional)
